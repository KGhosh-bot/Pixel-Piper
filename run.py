...
def main(args):
    ...
    token_indices = get_indices_to_alter(stable, prompts) if args.token_indices is None else args.token_indices
    ...
    for seed in args.seeds:
        ...
        controller = AttentionStore()
        image,loss_value_per_step,attention_maps = run_on_prompt(prompt=prompts,
                                                                                    model=stable,
